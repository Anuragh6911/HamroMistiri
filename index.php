  ...
  <section id="services">
    ...
    <div class="content-box">
      <div class="card" onclick="window.location='/HamroMistiri/carpenter.php';">
        ...
        <h2> Carpenter </h2>
        <p> Carpenters construct, erect, install, and repair structures and fixtures made from wood and other materials.
        </p>
      </div>
      ...
      <div class="card" onclick="window.location='/HamroMistiri/mechanics.php';">
        ...
        <h2> Mechanics </h2>
        <p> An auto mechanic performs maintenance, repairs, and inspections vehicles. They work on engines, drive belts,
          transmissions, and electronic systems.</p>
      </div>

      <div class="card" onclick="window.location='/HamroMistiri/plumber.php';">
        <i class="icons"> <img src="./icons/plumber.svg" height="35px"> </i>
        <h2> Plumber </h2>
        <p> A plumber is a person whose job is to connect and repair things such as water and drainage pipes, baths, and
          toilets</p>
      </div>
      ...
      <div class="card" onclick="window.location='/HamroMistiri/technician.php';">
        ...
        <h2> Technician </h2>
        <p> Professional technican will provide tech support and services such as computer repair, TV mounting and smart
          home setup</p>
      </div>
      ...
      <div class="Form">
        ...
        <div>
          <form class="Login-Form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
            ...
            <div class="Emailflex">
              <div>
                <input type="text" id="Fullname" name="fname" placeholder="Your Full Name" required />
              </div>
              <div class="Emailclass">
                <input type="email" id="Email" name="email_1" placeholder="Your Email" required />
              </div>
            </div>
            ...
            <input type="text" id="PanNumber" name="pan" placeholder="Enter Your Pan-Number" required />
  ...
  <section id="section4">
    <div class="container">
      ...
      <div class="body2">
        ...
        <h1>About Us</h1>
        <P> The home services system is in high demand as it is incredibly useful for everybody in this busy schedule
          lifestyle. ​‘Hamro Mistiri’ is a web application that will let users search for home services online . The
          services include Plumber, Mechanics, Electrician, Technician, etc. ​
          It will provide freelancing opportunities for service providers. ​Home Service Providers and customers are
          only two users of our system. The home service providers are required to register to this website mentioning
          their roles. The users who are in need of services can browse the services provided and check the review of
          service providers. ​
          This web application will be beneficial to the individual especially for the ones who are relocating from one
          area to a different area.</br>
          </br>
          ...
          Whenever we are in need of a service we contact the service providers that we already know and that limits us
          to the only option. The main problem is that we don’t have any other service providers besides them and we
          have no choices or ways to get to them.​
          So to solve this very problem we are building a web application that allows the users to get a vast possible
          availability of those service providers through our web application. ​​
        </P>
        <h1>Why Hamro Mistiri ?</h1>

        <P>
          During this pandemic many lost their job and those who were working abroad were forced to return to their
          country, this created increase in unemployment Rate. We a team of three members called as 'Three Motivated
          Minds' dicide to help those people who have skills but no employemnt opportunities. We create this web
          applicataion so that people having some skills of plumbing, painting etc. can find a way to earn their leaving
          by marketing their skills in our website.We believe in bringing smile in face's of thoes people who weren't
          able to even think about it.
        </P>
